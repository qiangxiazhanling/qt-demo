...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout_4.setWidget(8, QtWidgets.QFormLayout.LabelRole, self.label_17)
        self.dept = QtWidgets.QComboBox(self.formLayoutWidget_2)
        self.dept.setObjectName("dept")
        self.formLayout_4.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.dept)
        self.upload_dept = QtWidgets.QPushButton(self.formLayoutWidget_2)
        self.upload_dept.setObjectName("upload_dept")
        self.formLayout_4.setWidget(10, QtWidgets.QFormLayout.SpanningRole, self.upload_dept)
        self.line_4 = QtWidgets.QFrame(self.formLayoutWidget_2)
        self.line_4.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_4.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_4.setObjectName("line_4")
        self.formLayout_4.setWidget(11, QtWidgets.QFormLayout.SpanningRole, self.line_4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.typebox.setItemText(1, _translate("MainWindow", "防干烧"))
        ...
        self.label_17.setText(_translate("MainWindow", "所属车间"))
        self.upload_dept.setText(_translate("MainWindow", "上传所属车间配置"))
